...
try:
    ...
    from src.SemaMutator.SemaMutator import SemaMutator
except:
...
class Sema:
    def __init__(self, is_from_tc=True, is_from_web=False):
        ...
        self.args_parser = ArgumentParserTC(self.tool_scdg, self.tool_classifier, self.tool_mutator)        
        if is_from_web:
